...
extern int Android_OnPadDown(int device_id, int keycode, int meta_state, int scan_code, int unichar, int repeat_count);
extern int Android_OnPadUp(int device_id, int keycode, int meta_state, int scan_code, int unichar);

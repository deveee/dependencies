...
JNIEXPORT jint JNICALL SDL_JAVA_CONTROLLER_INTERFACE(onNativePadDown)(
        JNIEnv *env, jclass jcls,
        jint device_id, jint keycode, jint meta_state, jint scan_code, jint unichar, jint repeat_count);

JNIEXPORT jint JNICALL SDL_JAVA_CONTROLLER_INTERFACE(onNativePadUp)(
        JNIEnv *env, jclass jcls,
        jint device_id, jint keycode, jint meta_state, jint scan_code, jint unichar);
...
static JNINativeMethod SDLControllerManager_tab[] = {
    ...
    { "onNativePadDown",        "(IIIIII)I", SDL_JAVA_CONTROLLER_INTERFACE(onNativePadDown) },
    { "onNativePadUp",          "(IIIII)I", SDL_JAVA_CONTROLLER_INTERFACE(onNativePadUp) },
...
{
    // STK only needs controller manager
...
JNIEXPORT jint JNICALL SDL_JAVA_CONTROLLER_INTERFACE(onNativePadDown)(
                                    ...
                                    jint device_id, jint keycode, jint meta_state, jint scan_code, jint unichar, jint repeat_count)
{
    return Android_OnPadDown(device_id, keycode, meta_state, scan_code, unichar, repeat_count);
}
...
JNIEXPORT jint JNICALL SDL_JAVA_CONTROLLER_INTERFACE(onNativePadUp)(
                                    ...
                                    jint device_id, jint keycode, jint meta_state, jint scan_code, jint unichar)
{
    return Android_OnPadUp(device_id, keycode, meta_state, scan_code, unichar);
}
